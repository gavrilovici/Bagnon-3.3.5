...
function PlayerSelector:GetPlayerIcon()
	...
	if sex == 3 then
		return string.format([[Interface\AddOns\Bagnon-3.3.5\textures\Achievement_Character_%s_%s]], enRace, 'Female')
	end
	return string.format([[Interface\AddOns\Bagnon-3.3.5\textures\Achievement_Character_%s_%s]], enRace, 'Male')
end